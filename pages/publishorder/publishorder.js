...
Page({
  ...
  data: {
    ...
    array3: ['请选择单位', '个', '组'],
    index3: 0,
    huoWuLeiXingList: ['如证件、服装等', '服装', '食品'],
    huoWuLeiXingIndex: 0,
    baoZhuangFangShiList: ['如纸箱、木箱等', '木箱', '纸箱'],
  ...
  send() {
    ...
    wx.request({
      url: app.globalData.url + '/order/order-insert?' + param,
      header: {
      ...
      data: {
        ...
        xiangShu: that.data.xiangShu,
        xiangShuUnit: that.data.xiangShuUnit,
      },
